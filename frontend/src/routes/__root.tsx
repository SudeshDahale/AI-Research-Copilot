  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        {error?.message && (
          <div className="mt-3 rounded-md border border-destructive/30 bg-destructive/10 p-2.5 text-left text-xs font-mono text-destructive">
            {error.message}
          </div>
        )}
  ...
  head: () => ({
    meta: [
      ...
      { title: "Arclight — Research, organized." },
      {
        name: "description",
        content:
          "A calm, scalable workspace for finding, reading, and synthesizing scientific papers.",
      },
      { name: "author", content: "Arclight" },
